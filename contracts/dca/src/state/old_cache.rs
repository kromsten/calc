...
pub const OLD_CACHE: Item<Cache> = Item::new("cache_v20");

pub const OLD_LIMIT_ORDER_CACHE: Item<LimitOrderCache> = Item::new("limit_order_cache_v20");
...
pub const OLD_SWAP_CACHE: Item<SwapCache> = Item::new("swap_cache_v20");
