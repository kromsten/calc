...
use cosmwasm_std::{
    ...
    Addr, DepsMut, Empty, Env, MemoryStorage, 
...
use crate::{
    ...
    , 
    tests::constants::{
        DCA_CONTRACT, DENOM_AARCH, DENOM_UUSDC, ROUTER_CONTRACT
    }, 
    types::{
        config::Config, pair::{Pair, PopulatedPair}, pool::{PoolType, PopulatedPool}, route::{HopInfo, Route, RouteHop}
    }
};
...
pub fn routed_pairs_real_implicit() -> Vec<Pair> {
    vec![
        Pair::new_routed(
            ...
            AssetInfo::Token {
                contract_addr: "archway1erqguqc3hmfajgu7e2dvgaccx6feu5ru3gyatdxu94p66j9hp7msn2kcqp".to_string(),
            },
            vec![
                RouteHop {
                    denom: "archway1sdzaas0068n42xk8ndm6959gpu6n09tajmeuq7vak8t9qt5jrp6sjjtnka".to_string(),
                    prev: HopInfo {
                        address: "archway1flsdgve559shl8fvqfrk3p2wdxn82ykqyqk7w2wjaw7p3gnhj3esfmq8t0".to_string(),
                    ...
                    next: Some(HopInfo {
                        address: "archway1903dqer5mdy4wen9duxhm7l76gw20vzk2vwm6t7zk305c0m38ldqjncc9f".to_string(),
        ...
        Pair::new_routed(
            AssetInfo::Token {
                contract_addr: "archway1sdzaas0068n42xk8ndm6959gpu6n09tajmeuq7vak8t9qt5jrp6sjjtnka".to_string(),
            },
            AssetInfo::Token {
                contract_addr: "archway1lcxaem4gqnp2mdeh5hawacxlzge8e6wzjaat73ahpf2rclqv9v4sj8e4kf".to_string(),
            },
            vec![
                RouteHop {
                    denom: "archway1mmu32f7hn0fyw8gh57xl5uhaqu4pq5xx59ynf0tju60n2nzha0as3vtmcm".to_string(),
                    prev: HopInfo {
                        address: "archway1jdrvvzd2tcfvhvyaedy7e8s92lh2m3a3jklvn74768fh6n5quh4sl6rgkx".to_string(),
                ...
                RouteHop {
                    denom: "archway12defza8nz2d2a3hgt6tftku28ly5lglsna69j7rpjeukg4pz8qese2326s".to_string(),
                    prev: HopInfo {
                        address: "archway1gzumcx38q446k9mup02cvmc4xjrlwa6xhnram3lghw2te8zeu7rqndhcrq".to_string(),
                        pool_type: PoolType::Stable, // Assuming PoolType is defined and filled correctly
                        asset_info: AssetInfo::Token {
                            contract_addr: "archway1mmu32f7hn0fyw8gh57xl5uhaqu4pq5xx59ynf0tju60n2nzha0as3vtmcm".to_string(),
                        },
                    },
                    next: Some(HopInfo {
                        address: "archway1gzumcx38q446k9mup02cvmc4xjrlwa6xhnram3lghw2te8zeu7rqndhcrq".to_string(),
